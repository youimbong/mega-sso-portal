...
import { createApp, deleteApp, listAllApps, toggleApp } from '../apps.js'
...
export async function adminRoutes(app: FastifyInstance): Promise<void> {
  ...
  app.post('/admin/apps', async (request, reply) => {
    ...
    if (!parsed.success) {
      ...
      return reply.code(422).view('admin/form', {
    ...
    return reply.view('admin/after-create', { apps: await listAllApps() })
  })
  ...
  app.post<{ Params: { id: string } }>('/admin/apps/:id/delete', async (request, reply) => {
    ...
    return reply.view('admin/table', { apps: await listAllApps() })
  })
